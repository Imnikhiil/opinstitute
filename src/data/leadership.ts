...
export const leadership: Leader[] = [
  ...
  },
  {
    ...
    message:
      "At OP Institute of Studies, I oversee academic quality and day-to-day management — from classroom standards and teacher coordination to student mentorship — so every learner gets structured guidance toward strong results.",
    initials: "M",
    accent: "brand",
  },
];
