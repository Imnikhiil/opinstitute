...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content:
      "As working parents, the app-based updates give us complete peace of mind. We can see photos and daily activities. My daughter has become so confident and social since joining OP Kids.",
    rating: 5,
    category: "preschool",
  },
  {
