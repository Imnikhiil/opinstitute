...
export const faqs: FAQ[] = [
  ...
  {
    id: "2",
    question: "What courses do you offer at OP Institute of Studies?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Both OP Institute of Studies and OP Kids Pre School are located at A-374, Street No. 11, Mahavir Enclave Part 2, New Delhi 110059. We are easily accessible from all surrounding areas.",
    category: "general",
  },
  {
    id: "5",
  ...
  {
    id: "6",
    question: "What safety measures are in place at OP Kids Pre School?",
    answer:
  ...
  },
  {
    ...
    answer:
      "OP Institute of Studies is open Monday to Saturday and closes at 9:00 PM, with multiple batch options available. OP Kids Pre School is open Monday to Saturday and closes at 6:00 PM. Sunday is a holiday for both.",
    category: "general",
  },
];
