        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal direction="left">
            <div className="space-y-6">
              <div className="inline-flex rounded-2xl bg-white p-4 shadow-card">
                <Image
              ...
              <div className="flex flex-wrap gap-3">
                {["Play Group", "Nursery", "LKG", "UKG"].map((prog) => (
                  <span
                    key={prog}
                    className="px-4 py-2 rounded-full bg-white dark:bg-gray-900 shadow-card text-sm font-medium border border-kids-200 dark:border-kids-800"
                  >
                    {prog}
                  </span>
                ))}
              ...
              <div className="flex items-center gap-2">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 fill-kids-400 text-kids-400" />
                ))}
            ...
            <div className="relative">
              ...
              <div className="relative grid grid-cols-2 gap-3">
                ...
                <Image
                  ...
                  width={250}
                  height={200}
                  className="rounded-2xl object-cover h-40 w-full shadow-card mt-8"
                  loading="lazy"
                />
                <Image
