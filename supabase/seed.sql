...
('CA – Chartered Accountancy', 'Complete coaching for the Chartered Accountancy course — Foundation, Intermediate and Final levels — with concept clarity, practical training, and regular test series.', 'Foundation / Inter / Final', 'Class 12 pass (any stream) & graduates', array['Accounts, Law, Taxation & Costing','ICAI-based study material','Regular chapter-wise tests','Doubt-clearing sessions','Experienced commerce faculty'], 'professional', true, 1),
('CS – Company Secretary', 'Structured coaching for the Company Secretary program covering all stages, with focus on corporate law, governance, and thorough exam preparation.', 'CSEET / Executive / Professional', 'Class 12 pass & graduates', array['Corporate & business law','Governance & compliance','Mock tests & revisions','Personal mentorship','Updated study notes'], 'professional', false, 2),
('CMA – Cost & Management Accountancy', 'Expert guidance for the Cost & Management Accountancy course with emphasis on costing, financial management, and practical problem solving.', 'Foundation / Inter / Final', 'Class 12 pass & graduates', array['Cost & management accounting','Financial management','Practical numerical practice','Regular assessments','One-on-one guidance'], 'professional', false, 3),
('B.Com (Pass & Honours)', 'Comprehensive tuition for B.Com Pass and Honours students covering the complete university syllabus with exam-focused preparation.', '3 Years (Semester-wise)', 'Class 12 pass (Commerce preferred)', array['Complete semester syllabus','Accountancy & economics','Business studies & finance','Previous year papers','Result-oriented teaching'], 'degree', true, 4),
('School Tuition (Class I – VIII)', 'Strong foundation tuition for primary and middle school students across all subjects with personal attention and concept-based learning.', 'Yearly (All Subjects)', 'Class I to VIII students', array['All subjects covered','Homework & concept help','Regular practice tests','Small batches','Individual attention'], 'school', false, 5),
('Class IX & X (CBSE)', 'Board-focused coaching for Class 9 and 10 students with subject expertise, sample paper practice, and regular assessments.', '1 – 2 Years', 'Class 9 & 10 students', array['Subject-wise expert teachers','Sample paper practice','Revision before exams','Parent-teacher meetings','Board exam strategies'], 'school', true, 6),
('Class XI & XII (Commerce)', 'Specialized coaching for Class 11 & 12 Commerce students — Accountancy, Business Studies, Economics — building the base for CA/CS/CMA & B.Com.', '1 – 2 Years', 'Class 11 & 12 Commerce students', array['Accountancy & Economics','Business Studies','Board pattern papers','Career counselling','Doubt sessions'], 'school', false, 7);
...
('Arjun Mehta', 'CA Student – OP Institute', 'The faculty at OP Institute is exceptional. Their concept clarity in Accounts and Law and the regular test series helped me clear my CA exams. The personal attention made all the difference.', 5, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80', 'institute', 2),
...
('Neha Agarwal', 'CS Student – OP Institute', 'Clearing CS felt achievable because of the structured guidance here. The corporate law classes were detailed and the mentors were always available for doubts. Truly grateful.', 5, null, 'institute', 9);
...
('CA / CS / CMA Test Series', 'Every Sunday', 'Full-length mock tests for CA, CS and CMA students with detailed analysis and performance feedback.', 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=600&q=80', 'academic', 3),
